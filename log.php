...
<div class="panel-heading">
    <ul class="nav nav-tabs" role="tablist">
        ...
        <li role="presentation" class="active"><a href="admin_log.php?pid=draft">草稿管理</a></li>
...
<form action="admin_log.php?action=operate_log" method="post" name="form_log" id="form_log">
  ...
  <thead>
    ...
    <tbody>
      ...
      <tr>
      <td width="21"><input type="checkbox" name="blog[]" value="#" class="ids" /></td>
      <td width="490"><a href="#">文章标题</a>
         <!--  <img src="images/top.png" align="top" title="首页置顶" />
          <img src="images/sortop.png" align="top" title="分类置顶" />
          <img src="images/att.gif" align="top" title="附件：" />
          <sapn style="color:red;"> - 待审</sapn>
      ...
      <img src="images/vlog.gif" align="absbottom" border="0" /></a>
      </td>

      <td><a href="#">admin</a></td>
      <td><a href="#">文章分类</a></td>
      <td class="small">2017-01-23</td>
      <td class="tdcenter">2</a></td>
      <td class="tdcenter">22</a></td>
      </tr>
